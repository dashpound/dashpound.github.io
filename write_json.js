...
myObj = [
    ...
    {id: 'd1', year: 2015, label: 'CNA Insurance', title: 'Senior Financial Analyst', track:'Career', axisrank: 4, viz: 'Resume', size: 1, desc: 'Took new role with promotion to Long-Term Care'},
    {id: 'd1', year: 2016, label: 'CNA Insurance', title: 'Data Analyst', track:'Career', axisrank: 4, viz: 'Resume', size: 1, desc: 'Lateral move to Data Science career track in Long-Term Care'},
    ...
    {id: 'd1', year: 2020, label: 'CNA Insurance', title: 'Director, Data & Analytics', track:'Career', axisrank: 4, viz: 'Resume', size: 1, desc: 'Lateral move to new business unit in Strategic Investments'},
